...
public class ManageRoomsForm extends javax.swing.JFrame {
    ...
    jButton1_Refresh.setText("Refresh");
    ...
    jPanel1Layout.setHorizontalGroup(
        ...
        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                .addComponent(jButton1_Refresh, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        .addGroup(jPanel1Layout.createSequentialGroup()
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                    ...
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)))
            .addComponent(jButton1_Refresh, javax.swing.GroupLayout.DEFAULT_SIZE, 24, Short.MAX_VALUE)
            .addGap(30, 30, 30))
    );
    ...
    private void RoomEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RoomEditActionPerformed
        ...
        if(phone.trim().equals("")){
            JOptionPane.showMessageDialog(rootPane, "Enter the room phone nunmber please", "Empty Field Error",JOptionPane.WARNING_MESSAGE );
        }else{
            try{
            roomNumber = Integer.valueOf(TextFieldINumber.getText());
            
            if(room.editRoom(roomNumber, type, phone, isReserved))
            {
            JOptionPane.showMessageDialog(rootPane, "Room data updated successfully", "Add Room",JOptionPane.INFORMATION_MESSAGE );
            }else{
            JOptionPane.showMessageDialog(rootPane, "Room Data Not Updated", "Add room Error",JOptionPane.ERROR_MESSAGE );
             }
            }catch(NumberFormatException ex){
                JOptionPane.showMessageDialog(rootPane, ex.getMessage() + " - Enter the Room number", "room number Error",JOptionPane.ERROR_MESSAGE );
            }
    ...
    private void RoomRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RoomRemoveActionPerformed
        ...
        try{
            ...
            JOptionPane.showMessageDialog(rootPane, "Room data removed successfully", "Remove Room",JOptionPane.INFORMATION_MESSAGE );
            }else{
